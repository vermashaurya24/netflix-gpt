  ...
  return (
    <div className='pt-[10%] flex justify-center z-10'>
        <form className='w-1/2 bg-black bg-opacity-80 rounded-xl grid grid-cols-12'>
            <input type='text' className='py-2 px-4 m-2 col-span-9 rounded-lg bg-black bg-opacity-50 border border-white' placeholder={lang[currentLanguage]?.geminiInputFieldText} />
